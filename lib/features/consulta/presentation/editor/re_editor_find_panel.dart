// SOLO EVALUACIÓN, 2026-07-24 — vendido tal cual desde el ejemplo oficial
// del paquete `re_editor` (https://github.com/reqable/re-editor/blob/main/
// example/lib/find.dart, licencia MIT) porque `CodeFindPanelView` NO es
// parte del paquete publicado en pub.dev — el paquete solo expone el
// modelo (`CodeFindController`/`CodeFindValue`), la UI del panel de
// buscar/reemplazar la deja al consumidor. Usado únicamente por
// `re_editor_prototype_screen.dart`. Si se decide migrar el editor real a
// `re_editor`, este archivo hay que revisarlo/adaptarlo al tema visual de
// Faro en vez de dejarlo tal cual.
