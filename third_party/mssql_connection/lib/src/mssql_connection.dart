...
class MssqlConnection {
  ...
  /// Same as [getData], but skips the JSON encode/decode round trip — see
  /// [MssqlClient.executeRaw]'s doc comment for why.
  Future<Map<String, dynamic>> getDataRaw(String query) async {
    await _ensureConnectedOrReconnect();
    return _client!.executeRaw(query);
  }
